...
void imprimir(int ganhador, Sapo *sapo){
	if(ganhador==1){
		cout <<"***************************************************"<<endl;
		cout << "O sapo " << sapo[0].getname() << " venceu com " << sapo1.getpulos() <<" pulos e percorreu "<< sapo1.getdistancia()<< " metros" << endl;
		cout <<"***************************************************"<<endl;
		cout<<endl;
		cout << "Detalhes da corrida:" << endl;
		cout << sapo[0].getname()<<": "<< "Pulos: "<<sapo[0].getpulos()<<" Distância percorrida: "<<sapo1.getdistancia()<<"m"<<endl;
	...
	if(ganhador==2){
		cout <<"***************************************************"<<endl;
		cout << "O sapo " << sapo[1].getname() << " venceu com " << sapo2.getpulos() <<" pulos e percorreu "<< sapo2.getdistancia() << " metros" << endl;
		cout <<"***************************************************"<<endl;
		cout << "Detalhes da corrida:" << endl;
		cout<<endl;
